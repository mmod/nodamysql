...
#define nkNewV8HandleValue( original ) v8::Handle<v8::Value>::Cast( original )
...
#define nkNewV8HandleValue( original ) original
...
class Driver : public node::ObjectWrap
{
	...
	private:
		explicit Driver(
							v8::Persistent<v8::String> host = v8::Persistent<v8::String>::New( nkPreIsolatedOS nkNewV8HandleValue( nkNewV8StringOS( "localhost" ) ) ),
							v8::Persistent<v8::String> port = v8::Persistent<v8::String>::New( nkPreIsolatedOS nkNewV8HandleValue( nkNewV8StringOS( "3306" ) ) ),
							v8::Persistent<v8::String> db = v8::Persistent<v8::String>::New( nkPreIsolatedOS nkNewV8HandleValue( nkNewV8StringOS( "test" ) ) ),
							v8::Persistent<v8::String> user = v8::Persistent<v8::String>::New( nkPreIsolatedOS nkNewV8HandleValue( nkNewV8StringOS( "test" ) ) ),
							v8::Persistent<v8::String> password = v8::Persistent<v8::String>::New( nkPreIsolatedOS nkNewV8HandleValue( nkNewV8StringOS( "password" ) ) ),
							v8::Persistent<v8::Object> model = v8::Persistent<v8::Object>::New( nkPreIsolatedOS nkNewV8HandleValue( v8::Object::New( nkIsolateOS ) ) ),
							v8::Persistent<v8::Boolean> modeled = v8::Persistent<v8::Boolean>::New( nkPreIsolatedOS nkNewV8HandleValue( v8::False( nkIsolateOS ) ) ),
							v8::Persistent<v8::Integer> type = v8::Persistent<v8::Integer>::New( nkPreIsolatedOS nkNewV8HandleValue( v8::Integer::New( nkPreIsolatedOS 0 ) ) ),
							v8::Persistent<v8::Integer> prepared = v8::Persistent<v8::Integer>( nkPreIsolatedOS nkNewV8HandleValue( v8::Integer::New( nkPreIsolatedOS 0 ) ) ),
							v8::Persistent<v8::Array> phmap = v8::Persistent<v8::Array>::New( nkPreIsolatedOS nkNewV8HandleValue( v8::Array::New( nkIsolateOS ) ) ),
							v8::Persistent<v8::Boolean> mapped = v8::Persistent<v8::Boolean>::New( nkPreIsolatedOS nkNewV8HandleValue( v8::False( nkIsolateOS ) ) ),
							v8::Persistent<v8::String> query = v8::Persistent<v8::String>::New( nkPreIsolatedOS nkNewV8HandleValue( nkNewV8StringOS( "" ) ) )
						);
		~Driver();
